...
void loop() {
  ...
  if(Serial.available() == 1){
   ...
   if(dato == 'H'){
       // Serial.println(humedad);
         Serial.write(humedad); Serial.write((unsigned int) humedad>>8); 
     }
   else if(dato == 'T'){
        //Serial.println(temperatura);
         Serial.write(temperatura); Serial.write((unsigned int) temperatura>>8); 
     }  
   else {
      //Serial.println("error");
          Serial.write(0); Serial.write((unsigned int) 0>>8); 
       }  
  }
